...
const getPizzaList = () => {
  fetch('/api/pizzas')
    // get all pizza data and transform it to JSON
    .then(response => response.json())
    .then(pizzaListArr => {
      // run each pizza through the 'printPizza' functiom using the '.forEach()' method
...
// Call the function that creates all the html for eah pizza
getPizzaList();
