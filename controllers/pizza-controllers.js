...
const pizzaController = {
    ...
    updatePizza({ params, body }, res) {
        ...
        // 'runValidators: true' 
        //  - since validators don't automatically run on updates, only on data creation, we need to tell mongoose to run the validation on this update so we can validate any new information.
